...
def load_latest_model(model, name="model.ckpt"):
    """
    Helper function for Load model
    :param model: current model
    :param name: model name
    :return: loaded model default model.ckpt
    """
    model.load_state_dict(torch.load(name))
    return model


def save_current_model(model, name='model.ckpt'):
    """
    Helper function for save model
    :param model: current model
    :param name: model name, default model.ckpt
    :return: None
    """
